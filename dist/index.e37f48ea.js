...
var _visualsView = require("./views/visualsView");
var _visualsViewDefault = parcelHelpers.interopDefault(_visualsView);
...
const init = function() {
    (0, _navigationViewDefault.default).addHandler(toggleNav, toggleCart);
};
init();

},{"./views/navigationView":"it1BP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model":"Y4A21","./views/visualsView":"7WGzZ"}],"it1BP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class NavigationView {
    ...
    addHandler(toggleNav, toggleCart) {
        this.#parent.addEventListener("click", function(e) {
            ...
            if (hamburgerMenu) toggleNav(hamburgerMenu.closest(".nav").querySelector(".nav__list"));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7WGzZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class VisualsView {
...
exports.default = new VisualsView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequirebd42")
